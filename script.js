...
const translations = {
  ...
  "Two directions I am building right now.": "我现在正在推进的两个方向。",
  "IN PROGRESS": "进行中",
  "Fengshui AI": "风水 AI",
  "A product experiment around making room and layout observations easier to see and explain.":
    "一个关于空间与布局观察的 AI 产品实验，目标是让判断更容易被看见、被解释。",
  "AI product": "AI 产品",
  "Spatial interface": "空间界面",
  "Quantitative model": "量化模型",
  "A research model for testing market signals with code, data, and disciplined review.":
    "一个用代码、数据和复盘来检验市场信号的研究模型。",
  "Signal testing": "信号测试",
...
const attributeCopy = {
  en: {
    ...
    ".current-grid": { "aria-label": "Current projects" },
